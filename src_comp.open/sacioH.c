/*******************************************************************
*			sacioH.c
* minor modification for convenience by H Kim Dec 2017
* SAC I/O functions:
*	rsac_hdr	read SAC header
*	rsac		read SAC binary data
*	rsac_2		read SAC data with cut option
*	wsac		write SAC binary data
*	wsac_2		write 2 1D arrays as XY SAC data
*	sachdr2		creat new sac header
...
SACHEAD    sachdr2( float dt, int ns, float b0)
{
  SACHEAD	hd = sac_null;
  hd.npts = ns;
  hd.delta = dt;
